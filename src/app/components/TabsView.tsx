      ...
      <div className="w-full max-w-4xl mx-auto mt-2">
        {activeTab === null ? (
          <Box className="rounded-2xl shadow-xl bg-black/80 border-l-8 border-red-700 p-8 md:p-12 animate-fadeIn text-center">
            <h3 className="text-2xl md:text-3xl font-extrabold text-white mb-4 uppercase tracking-wider" style={{fontFamily:'Oswald, Montserrat, Arial, sans-serif'}}>Choose a Program</h3>
            <p className="text-lg text-gray-200 max-w-2xl mx-auto" style={{fontFamily:'Montserrat, Arial, sans-serif'}}>
